...
public class ClientService : IClientService
{
    ...
    public async Task<IReadOnlyList<ClientDto>> GetClientByNameAsync(SearchByNameRequest request, CancellationToken cancellationToken, int pageNumber = 1, int pageSize = 10)
    {
        var clientEntity = await _clientRepository.SearchClientByNameAsync(request.FirstName, request.LastName, cancellationToken, pageNumber, pageSize);
