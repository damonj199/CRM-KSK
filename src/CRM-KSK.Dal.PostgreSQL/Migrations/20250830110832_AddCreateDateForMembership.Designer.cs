...
namespace CRM_KSK.Dal.PostgreSQL.Migrations
{
    ...
    [Migration("20250830110832_AddCreateDateForMembership")]
    partial class AddCreateDateForMembership
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CRM_KSK.Core.Entities.MembershipDeductionLog", b =>
                {
                    ...
                    b.Property<bool>("IsMorningMembership")
                        .HasColumnType("boolean")
                        .HasColumnName("isMorningMembership");
